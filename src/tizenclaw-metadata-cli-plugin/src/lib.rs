...
const METADATA_KEY: &[u8] = b"http://tizen.org/metadata/tizenclaw/cli\0";
const PLUGIN_NAME: &str = "CLI";
const PLUGIN_INFO_JSON: &str = r#"{
  "plugin_id": "tizenclaw-cli",
  "platform_name": "TizenClaw CLI",
  "version": "1.0.0",
  "priority": 50,
  "capabilities": ["cli_metadata", "command_discovery"]
}"#;
