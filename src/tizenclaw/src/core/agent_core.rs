...
// Keep Korean level-heading support for existing grounded task fixtures.
...
const COMMON_FILE_EXTENSIONS: &[&str] = &[
    "c", "cc", "cfg", "conf", "cpp", "css", "csv", "doc", "docx", "env", "gif", "h", "hpp", "htm",
    "html", "ics", "ini", "java", "jpeg", "jpg", "js", "json", "lock", "log", "md", "pdf", "png",
    "py", "pyi", "rb", "rs", "scss", "sh", "sql", "svg", "toml", "ts", "tsx", "txt", "xml", "yaml",
    "yml",
];
...
#[path = "agent_core/process_prompt_contracts.rs"]
mod process_prompt_contracts;
#[path = "agent_core/process_prompt_loop.rs"]
mod process_prompt_loop;
