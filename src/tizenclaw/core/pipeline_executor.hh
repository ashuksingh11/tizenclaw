...
// Skill Pipeline Engine — deterministic multi-step
// skill/tool execution with variable interpolation
#ifndef TIZENCLAW_CORE_PIPELINE_EXECUTOR_H_
#define TIZENCLAW_CORE_PIPELINE_EXECUTOR_H_
...
#endif  // TIZENCLAW_CORE_PIPELINE_EXECUTOR_H_
