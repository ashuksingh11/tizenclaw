...
3. **Test & Review (MANDATORY)**: You actively run the feature on the device (using `tizenclaw-cli`, `dlogutil`, etc.) and ensure it works perfectly. You also perform the code review checklist.
