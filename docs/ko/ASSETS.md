...
## 컴패니언 프로젝트: tizenclaw-assets

RAG 자산은 통합 패키지 **[tizenclaw-assets](https://github.com/hjhun/tizenclaw-assets)**에 포함되어 있습니다. ONNX Runtime, OCR 엔진, 임베딩 모델도 함께 제공됩니다.
...
# deploy.sh가 ../tizenclaw-assets를 자동 감지하여 함께 빌드합니다
./deploy.sh
...
# 방법 C: CJK 전체 OCR 모델 사용 (기본값은 한국어+영어 경량 모델)
cd ../tizenclaw-assets
